                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <!-- property with : in front => its value is treated as an expression, not a string -->
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pb-3 pt-4">
                <div class="flex items-center px-5">
                    ...
                    <div class="ml-3">
                        <div class="text-base font-medium leading-none text-white">Mattia Fontana</div>
                        <div class="text-sm font-medium leading-none text-gray-400">mf@example.com</div>
                    </div>
